        ...
        <div className='label-input-container'>
             ...
             <Dropdown className="request-dropdown-container label-input-container">
                    ...
                    <Dropdown.Menu className="sharp-dropdown-menu">
                        <Dropdown.Item style={{textDecoration:'none !important'}} onClick={()=>handleChangeRequest("GET")}>GET</Dropdown.Item>
                        <Dropdown.Item style={{textDecoration:'none !important'}} onClick={()=>handleChangeRequest("POST")}>POST</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                </div>
